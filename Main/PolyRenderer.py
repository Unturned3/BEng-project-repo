...
class PolyRenderer3D():
    ...
    def __init__(self, width, height):
        ...
        self.ctx = moderngl.create_standalone_context(gc_mode='auto')
    ...
    def update_poly(self, uid, verts):
        self.polys[uid].verts = np.array(verts, dtype='f4')
        self.polys[uid].vbo.write(self.polys[uid].verts.tobytes())
    ...
    def render(self, showPolys, showPoints):
